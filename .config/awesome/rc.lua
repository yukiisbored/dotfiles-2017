...
beautiful.init("/home/yuki/.config/awesome/themes/yuki/theme.lua")
...
-- Create a simple space widget
myspace = wibox.widget{
   text = ' ',
...
mytextvolume = awful.widget.watch('yukivol', 1)
